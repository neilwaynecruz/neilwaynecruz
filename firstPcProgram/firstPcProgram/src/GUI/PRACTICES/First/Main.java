...
public class Main {
    public static void main(String[] args) {
        ...
        ImageIcon image = new ImageIcon("C:\\mainMasterBranch\\firstPcProgram\\firstPcProgram\\src\\GUI\\PRACTICES\\First\\Reaction dog face meme.png");
        ...
        frame.setIconImage(new ImageIcon("C:\\mainMasterBranch\\firstPcProgram\\firstPcProgram\\src\\GUI\\PRACTICES\\First\\—Pngtree—java programming icon_6044136.png").getImage());
        frame.add(label);
